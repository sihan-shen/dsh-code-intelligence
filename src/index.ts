...
export { apply, CodeIntelligenceSettingsSchema, inject, mountCodeIntelligence, name, provide } from './plugin.js'
export type { CodeIntelligenceConfig, CodeIntelligenceRuntimeOptions, CodeIntelligenceSettings } from './plugin.js'
export type { RepoMapOptionsV1, SymbolQueryV1 } from './projections.js'
export type { CacheConfigV1, SnapshotConfigV1, SourceMeasurementV1, RepositorySnapshotV1, RepoFileSummaryV1 } from './types.js'
...
// P0 foundation, queries, refresh, and optional cache integration. V1 programmatic
// exports above remain available; the default plugin registers the five P0 tools.
